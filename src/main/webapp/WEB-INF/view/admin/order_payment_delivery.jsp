			...
			<tbody>
				<c:forEach items="${allPaymentList }" var="allPaymentList">
					<tr>
						...
						<td style="text-align: center;"><a href="${root }mypage/order/orderInfo_Details?order_idx=${allPaymentList.order_idx}">자세히 보기</a></td>
						<td style="text-align: center;"><fmt:formatNumber pattern="###,###,###" value="${allPaymentList.paymentPrice-3000}" />원</td>
						<td style="text-align: center;">3,000원</td>
						<td style="text-align: center;"><fmt:formatNumber pattern="###,###,###" value="${allPaymentList.paymentPrice}" />원</td>
