...
<script type="text/javascript">
	...
	function resetInputMemberEmail() {
		...
		//이런경우(false)는 회원가입 안된다. BindingResult의 오류로
		$("#inputMemberEmail").val('false');
					...
					<div class="card-body">
						<form:form action='${root }member/modify_proc' method='post' modelAttribute="modifyMemberDTO">
							...
							<div class="form-group">
								...
								<form:input path="member_name" class='form-control' readonly="true" />
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="input-group">
									...
									<div class="input-group-append">
										<button type="button" class="btn btn-danger" onClick="checkEmailInModify();">이메일 중복확인</button>
									</div>
								</div>
